    ...
    <section id="wishlist" className="py-24 bg-white border-b border-brand-grove/30 relative overflow-hidden">
      ...
      <div className="max-w-2xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="text-center mb-12">
          ...
          <p className="text-brand-primary text-xs uppercase tracking-widest mt-2">
        ...
        {status === 'success' ? (
          <motion.div 
            ...
            className="text-center p-12 bg-white border border-brand-primary/50 shadow-sm"
          >
