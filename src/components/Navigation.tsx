        ...
        <AnimatePresence>
          {mobileMenuOpen && (
            <motion.nav
              ...
              className={cn(
                "absolute left-0 right-0 w-full bg-brand-logo-bg bg-pattern-lines border border-brand-grove/40 px-6 py-8 flex flex-col space-y-6 md:hidden shadow-xl text-brand-light-1",
